...
const Skills = () => {
  return (
    <section id='skills'>
      ...
      <span className='skillsDesc'> As a passionate software developer, I specialize in transforming ideas into highly functional and efficient software solutions. My goal is to create user-centered applications that not only perform seamlessly but also provide an intuitive and engaging experience for users.</span>
