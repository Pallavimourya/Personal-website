    ...
    return (
        <nav className="navbar">
            ...
            <div className="desktopMenu">
                ...
                <Link activeClass="active" to="clients" spy={true} smooth={true} offset={-50} duration={500} className="desktopMenuListItem">Certificates</Link> 
            </div>
            <Link to="contact" spy={true} smooth={true} offset={-50} duration={500} className="desktopMenuBtn">
                <img src={btnimg} alt="Contact Icon" className="desktopMenuImg"/>Contact Me
            </Link>
            ...
            <div className="navMenu" style={{ display: showMenu ? 'flex' : 'none' }}>
                ...
                <Link activeClass="active" to="clients" spy={true} smooth={true} offset={-50} duration={500} className="ListItem" onClick={() => setShowMenu(false)}>Certificates</Link> 
